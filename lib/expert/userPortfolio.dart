...
class UserPortfolio extends StatefulWidget {
  ...
  final String seller;
  UserPortfolio({required this.seller});


  @override
  State<UserPortfolio> createState() => _AllPortfolioListState();
}

class _AllPortfolioListState extends State<UserPortfolio> {
  ...
  Widget searchListPortFolio() {
    return StreamBuilder(
      stream: FirebaseFirestore.instance.collection("expert").where('userId', isEqualTo: widget.seller).snapshots(),
