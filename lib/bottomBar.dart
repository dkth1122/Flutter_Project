...
class _CircularDialogState extends State<CircularDialog> {
  ...
  List<IconData> iconData = [Icons.shopping_cart,Icons.card_giftcard,  Icons.headset_mic,  Icons.attach_money, Icons.chat,  Icons.star, Icons.shopping_bag,  Icons.insert_drive_file];
